<div class="my_meta_control">
    ...
    <?php while($mb->have_fields_and_multi('ourteam',array('length' => 2))): ?>
        ...
        <label><?php esc_html_e('Name', 'g5plus-handmade'); ?></label>
        ...
        <label><?php esc_html_e('Link', 'g5plus-handmade'); ?></label>
        <input class="form-control" type="text" name="<?php esc_attr($mb->the_name()); ?>" value="<?php esc_attr($mb->the_value()); ?>"/>

        <?php $mb->the_field('socialIcon'); ?>
        <label><?php esc_html_e('Icon', 'g5plus-handmade'); ?></label>
    ...
    <p>
        <a href="#" class="docopy-ourteam button"><?php esc_html_e('Add Social', 'g5plus-handmade'); ?></a>
    </p>
</div>
<style>
