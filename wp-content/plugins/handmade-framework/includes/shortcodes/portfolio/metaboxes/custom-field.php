...
<div class="portfolio-custom-field">
    ...
    <p>
        <a href="#" class="docopy-portfolio_custom_fields button"><?php esc_html_e('Add custom field', 'g5plus-handmade'); ?></a>
