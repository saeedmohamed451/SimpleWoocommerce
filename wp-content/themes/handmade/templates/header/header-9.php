...
?>
<header id="header" class="<?php echo join(' ', $header_class) ?>" <?php if(!is_front_page()){?>style="margin-bottom: 4%;box-shadow: 0 1px 10px 0 rgba(0, 0, 0, 0.2);" <?php }else{ ?> style="position: unset !important;"<?php } ?>>
	<div class="<?php echo join(' ', $header_nav_wrapper) ?>" style="max-height: 60px;">
		<div class="container">
			<div class="header-wrapper">
				<div class="header-left" style="vertical-align: inherit;">
