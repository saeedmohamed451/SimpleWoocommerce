  ...
  public function show_field_repeater( $field, $meta ) {
    ...
    $c = 0;
      ...
      if (count($meta) > 0 && is_array($meta) ){
        ...
        echo '" alt="'.esc_html__('Remove','g5plus-handmade').'" title="'.esc_html__('Remove','g5plus-handmade').'" id="remove-'.$field['id'].'"></div>';
        $c = $c + 1;
    ...
    echo '" alt="'.esc_html__('Add','g5plus-handmade').'" title="'.esc_html__('Add','g5plus-handmade').'" id="add-'.$field['id'].'"><br/></div>';
  ...
  public function footer_js(){
    ...
    jQuery(document).ready(function(){
      ...
      function clear_form_meta(){
          ...
          jQuery(".mupload_img_holder").next().next().next().val("<?php esc_html_e('Upload Image','g5plus-handmade'); ?>");
